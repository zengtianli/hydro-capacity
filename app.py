...
from src.capacity.calc_core import (
...
from src.capacity.xlsx_parser import (
...
# 页面配置
# ============================================================
page_config("纳污能力计算 - Hydro Capacity")
...
with st.sidebar:
    ...
    *水库纳污能力：*
    ...
    sample_file = Path(__file__).resolve().parent / 'data' / 'sample' / '示例输入.xlsx'
...
# 页脚
# ============================================================
footer("纳污能力计算", repo_url="https://github.com/zengtianli/hydro-capacity")
